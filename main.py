...
4,1つの国で最も多くGPを開催している国はどこ？,①アメリカ,①アメリカ,②イタリア,③イギリス,④オーストラリア,選択式,Mid,サトマサ,,F１常識,,発案,設問数
5,"晴れている時のタイヤと雨の時のタイヤを合わせると
何種類のタイヤが準備されているか",②5種類,①4種類,②5種類,③6種類,④7種類,選択式,Mid,サトマサ,"Midじゃね？⇒Midに変更で",F１常識,,gen,17
...
13,鈴鹿サーキットは何県何市？,②三重県鈴鹿市,①愛知県鈴鹿市,②三重県鈴鹿市,③大阪府鈴鹿市,④静岡県鈴鹿市,選択式,Soft,サトマサ,"スーパーソフトやんこれくらい答えられないとこまる←そうだねｗ",F１常識,,,
...
28,VCARBの正式名称を答えよ,②Visa CashApp RB,①Visa Cash RB,②Visa CashApp RB,③Visa Card RB,④Viza Card RB,選択式,Hard,サトマサ,,VCARB,,,
29,"ダニエル・リカルド選手が
...
54,"マシンがスタート出来ないのをDNS、ではマシンがリタイアしたときの表記は？",③DNF,①DNR,②DNQ,③DNF,④DNP,選択式,Soft,サトマサ,,F１常識,,,
...
75,エディ・アーバインの彼女を寝取り、公式記者会見の場で水をかけられたのは誰か？,④ハッキネン,①ミハエル・シューマッハ,②ミカ・サロ,③ラルフ・シューマッハ,④ハッキネン,選択式,Mid,アブダビ,,,,,
76,FIA会長マックス・モズレーの某スキャンダルが発覚した時、元ワールドチャンピオンのネルソン・ピケが残したコメントは次のうちどれか？,③なぜ僕も誘ってくれなかったんだ？,①彼のお尻が心配だ,②面白そうだね,③なぜ僕も誘ってくれなかったんだ？,④どうなるか見てみよう,選択式,Mid,アブダビ,,,,,
...
79,F1の歴史上唯一、V12エンジンでチャンピオンを取ったことがあるのは○○だけである,④ホンダ,①フェラーリ,②フォード,③BMW,④ホンダ,選択式,Mid,アブダビ,,,,,
80,今週(5/22)のWFT角田選手はどこからリモート出演した？,②ファエンツァの自宅,①ミルトン・キーンズの工場,②ファエンツァの自宅,③モナコのホテル,④イモラサーキット,選択式,Mid,アブダビ,,,,,
81,角田選手は相模原市の○○である。,②ホームタウンアスリート,①名誉市民,②ホームタウンアスリート,③町内会会長,④公式イメージキャラクター,選択式,Mid,アブダビ,,,,,
82,一時期危険性が高いとしてレギュレーションで禁止されていたが、数年前に復活した技術は何か？,②グラウンドエフェクト,①給油,②グラウンドエフェクト,③アクティブサス,④TCS,選択式,Mid,アブダビ,,,,,
83,F1で始めてナイトレースが開催されたGPはどこ？,①シンガポールGP,①シンガポールGP,②ラスベガスGP,③アブダビGP,④カタールGP,選択式,Mid,アブダビ,,,,,
84,勝利したドライバーの最大ピットイン数は何回か?,③6,①4,②5,③6,④7,選択式,Mid,アブダビ,,,,,
85,去年DAZNが公開収録を提供したのはどのチームの関連施設？,④メルセデス,①レッドブル,②フェラーリ,③マクラーレン,④メルセデス,選択式,Mid,アブダビ,,,,,
86,今年からDAZNのF1配信に取り入れられた、レースを見ながらチャットで交流できるシステムは？,④Fan Zone,①Fun Zone,②Fun Chat,③Fan Chat,④Fan Zone,選択式,Mid,アブダビ,,,,,
87,ゲルハルトベルガーとアイルトンセナは、ロンデニスを○○のプールに突き落とした。○○は？,②ワニ園,①ホテル,②ワニ園,③ジム,④市民センター,選択式,Mid,アブダビ,,,,,
88,ターボエンジンのターボとはどんな技術か？,②排気圧でタービンを回し、吸気を圧縮する技術である,①モーターでタービンを回し、吸気を圧縮する技術である,②排気圧でタービンを回し、吸気を圧縮する技術である,③高回転域でバルブを大きく開き、吸気量を増やす技術である,④上記のどれでもない,選択式,Mid,アブダビ,,,,,
89,F1に一時存在していた予選専用タイヤの名前は？,②Qタイヤ,①Pタイヤ,②Qタイヤ,③Rタイヤ,④Sタイヤ,選択式,Mid,アブダビ,,,,,
90,TURBOの学名をもち、ターボエンジンの由来になったとも言われる貝は？,④サザエ,①ホタテ,②ホヤ,③ツブ,④サザエ,選択式,Mid,アブダビ,,,,,
91,アイルトン・セナの走行テクニックとして有名な「セナ足」とは何か？,③,①コーナーリング中にクラッチペダルを小刻みに煽る,②コーナーリング中にブレーキペダルを小刻みに煽る,③コーナーリング中にアクセルペダルを小刻みに煽る,④上記のどれでもない,選択式,Mid,アブダビ,,,,,
92,ホンダがF1に持ち込んだ、アクセルペダルをエンジンのスロットルと機械的に接続せず、電気信号のみでスロットル開度を決めるシステムをなんと呼ぶか？,④DBW,①ABW,②BBW,③CBW,④DBW,選択式,Mid,アブダビ,,,,,
93,F1をはじめ、自動車のハイブリッドシステムは、〇〇エネルギーを利用して発電を行っている,④回生,①回転,②位置,③スピード,④回生,選択式,Mid,アブダビ,,,,,
94,「雨が降ってきてるよ！」「いや、それは多分君の汗だよ」この無線のやり取りを行ったのは誰？,④ラッセル,①ノリス,②リカルド,③ベッテル,④ラッセル,選択式,Mid,アブダビ,,,,,
"""
